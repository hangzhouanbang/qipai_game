...
import com.anbang.qipai.game.cqrs.c.service.disruptor.SnapshotJsonUtil;
import com.anbang.qipai.game.init.InitProcessor;
...
@EnableFeignClients
public class QipaiGameApplication {
	...
	public static void main(String[] args) {
		SpringApplication.run(QipaiGameApplication.class, args);
	}
