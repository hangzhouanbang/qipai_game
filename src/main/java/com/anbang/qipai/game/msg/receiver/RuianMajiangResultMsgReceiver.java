...
import com.anbang.qipai.game.msg.service.RuianmjResultMsgService;
...
import com.anbang.qipai.game.plan.bean.historicalresult.majiang.RuianMajiangJuPlayerResult;
import com.anbang.qipai.game.plan.bean.historicalresult.majiang.RuianMajiangPanPlayerResult;
...
public class RuianMajiangResultMsgReceiver {
	...
	@Autowired
	private RuianmjResultMsgService ruianmjResultMsgService;
			...
			if (gid != null && dyjId != null && dthId != null) {
				...
				if (room != null) {
					...
					if (playerList != null) {
						...
						ruianmjResultMsgService.newJuResult(majiangHistoricalResult);
					}
				}
			}
		}
			...
			if (gid != null) {
				...
				if (room != null) {
					...
					if (playerList != null) {
						...
						ruianmjResultMsgService.newPanResult(majiangHistoricalResult);
					}
				}
			}
		}
